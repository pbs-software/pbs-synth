...
\def\startP{165}         %% page start (default=1)
...
\def\finalYr{2024}%% final year in model
\def\ncomm{3}%%      index g for commercial fishery (if more than one, this will need to be revised)
\def\nsurv{6}%%      index g for total number of surveys
\def\gsurv{4,...,9}%%      index g for all surveys
\def\gcomm{1,...,3}%%      index g for all commercial fisheries
\def\ugees{1,...,8}%%      index g for surveys/fisheries with age data (composition)
\def\qgees{4,...,9}%%      index g for surveys/fisheries with index data (abundance)

\newcommand{\spn}{Pacific Ocean Perch}
\newcommand{\spc}{POP}
...
\newcommand{\policyMax}{15,000}
\newcommand{\policyInc}{proportional}
...
%% Note: $\mr{POP}$ denotes `QCS+WCVI+WCHG'.}%
\label{tab:notate}
\\ \hline\\[-2.2ex]
...
%%----------------------------------------------------------
\\[-0.5ex]
\bec {\bf Selectivity pattern 20 ($\bfmi{g} \bf = 1,...,8$)} \eec 
...
\beq \elabel{Zats}
  Z_{ats} = M_{as} \sum\nolimits_{g \in 1,...,3} \, ( \, S_{atgs} \, F_{tg} \, )~;~~~ F_{tg} = \text{\footnotesize apical fishing mortality rate}
  \eeq \\
...
\beq \elabel{Cats}
  C_{ats} = \sum\nolimits_{g\in1,...,3}  \, \frac{ F_{tg} }{ Z_{ats}^\prime } \, w_{as} N_{ats} S_{atgs} \lambda_{ats}^\prime
  \eeq \\
...
%%rm (although POP male selectivity was fixed to be the same as that for females in this assessment).
...
%For each model run, the abundance index CVs were adjusted on the first reweight only using the process error $c_\text{p}$~= 0, 0, 0, 0, 0, and 0 in QCS+WCVI+WCHG ($g$=4,...,9).
...
Sensitivty runs (MCMC):\\
\tab \href{https://github.com/pbs-software/pbs-synth/tree/master/PBSsynth/inst/input/2023/POP/CST/Sens/Run17v18/17.00}{S01.R17v18} -- use Dirichlet-multinomial parameterisation\\
\tab \href{https://github.com/pbs-software/pbs-synth/tree/master/PBSsynth/inst/input/2023/POP/CST/Sens/Run27v1/27.01}{S02.R27v1} -- fix parameter Rdist for 5ABC to 0\\
\tab \href{https://github.com/pbs-software/pbs-synth/tree/master/PBSsynth/inst/input/2023/POP/CST/Sens/Run28v1/28.01}{S03.R28v1} -- fix parameter Rdist for 3CD to 0\\
\tab \href{https://github.com/pbs-software/pbs-synth/tree/master/PBSsynth/inst/input/2023/POP/CST/Sens/Run29v1/29.01}{S04.R29v1} -- apply no ageing error\\
\tab \href{https://github.com/pbs-software/pbs-synth/tree/master/PBSsynth/inst/input/2023/POP/CST/Sens/Run30v1/30.01}{S05.R30v1} -- use smoothed ageing error from age-reader CVs\\
\tab \href{https://github.com/pbs-software/pbs-synth/tree/master/PBSsynth/inst/input/2023/POP/CST/Sens/Run31v1/31.01}{S06.R31v1} -- use constant-CV ageing error\\
\tab \href{https://github.com/pbs-software/pbs-synth/tree/master/PBSsynth/inst/input/2023/POP/CST/Sens/Run32v1/32.01}{S07.R32v1} -- reduce commercial catch (1965-95) by 30\pc{}\\
\tab \href{https://github.com/pbs-software/pbs-synth/tree/master/PBSsynth/inst/input/2023/POP/CST/Sens/Run33v1/33.01}{S08.R33v1} -- increase commercial catch (1965-95) by 50\pc{}\\
\tab \href{https://github.com/pbs-software/pbs-synth/tree/master/PBSsynth/inst/input/2023/POP/CST/Sens/Run34v1/34.01}{S09.R34v1} -- reduce sigmaR to 0.6 (from 0.9)\\
\tab \href{https://github.com/pbs-software/pbs-synth/tree/master/PBSsynth/inst/input/2023/POP/CST/Sens/Run35v1/35.01}{S10.R35v1} -- increase sigmaR to 1.2 (from 0.9)\\
