...
d.code = "C:/Users/haighr/Files/Projects/R/Develop/PBSsynth/Authors/Rcode/develop/POP2023"
source(file.path(d.code, "set.controls.r"))
istock  = "POP"
unpackList(stock[[istock]][["Controls"]])
#appFdir = "C:/Users/haighr/Files/GFish/PSARC23/POP/Docs/WP/AppF_Results/"  ## where compo, senso, etc. reside
appFdir = "C:/Users/haighr/Files/GFish/PSARC/PSARC_2020s/PSARC23/POP/Docs/RD/AppF_Results/"
...
if (!exists("compo",envir=.GlobalEnv))
	load(paste0(appFdir,"compo.230925.rda"), envir=.GlobalEnv)
unpackList(compo)
...
if (!exists("senso",envir=.GlobalEnv))
	load(paste0(appFdir,"senso.230925.rda"), envir=.GlobalEnv)
