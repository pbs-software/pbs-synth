...
Ulist      = list(
	list(c(1979:1980,1982:1985,1988,1990:2013,2015:2017), NA, c(2004:2005,seq(2009,2021,2)), c(2004,2006,seq(2010,2018,2),2021), c(1980,1983,1989,1992,1995,2001), NA, NA, NA)
)
