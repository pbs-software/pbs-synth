...
\onefig{traceParams}{MCMC traces for the estimated parameters. Grey lines show the \Nmcmc~samples for each parameter, solid lines show the cumulative median (up to that sample), and dashed lines show the cumulative 0.05 and 0.95 quantiles.  Red circles are the MPD estimates. For parameters other than $M$ (if estimated), subscripts 1 and 3-8 correspond to fleets (fisheries and surveys).}
...
%%\onefig{pairsPars}{Kernel density plot of \Nmcmc~MCMC samples for 20 parameters. Numbers in the lower panels are the absolute values of the correlation coefficients.}
