...
r.synth = c("PBSsynth", "plotFuns", "utilFuns", "calcStdRes", "ptab", "convPN", "plotSS.pars", "plotSS.pairs", "weightAF")
...
species.name="Canary Rockfish"; strSpp="CAR"; assyr=2022  ## also set on L169
...
species.name="Canary Rockfish"; strSpp="CAR"; assyr=2022  ## also set on L96
...
\input{\Sexpr{"../../../CAR2022/runHistory"}}
