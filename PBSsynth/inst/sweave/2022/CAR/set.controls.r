...
r.awatea = c("current/plotFuns", "mochaLatte", "panelBoxes","plotTraj","panelTraces","panelChains","plotACFs")
...
## Use static code specific to the 2022 Canary Rockfish stock assessment
d.synth = "C:/Users/haighr/Files/Projects/R/Develop/PBSsynth/Authors/Rcode/develop/CAR2022/"
r.synth = c("PBSsynth","plotFuns","utilFuns","plotSS.pars","plotSS.ts","plotSS.index","plotSS.francis", "plt.selectivity", "plotSS.selex", "make.multifig", "plotSS.comps", "plt.cohortResids", "plotSS.stdres", "plotSS.rdevs", "calcStdRes", "ptab", "convPN", "weightAF", "plotSS.pmcmc")
...
for (i in 1:length(stolab)) {
	...
	stock[[ii]] = list()
	stock[[ii]][[jj]] = list()
	stock[[ii]][[jj]][["name"]]            = switch(i, "CAR~BC", "")
	stock[[ii]][[jj]][["spp.code"]]        = "CAR"
	stock[[ii]][[jj]][["spp.name"]]        = "Canary Rockfish"
	stock[[ii]][[jj]][["latin.name"]]      = "Sebastes pinniger"
	stock[[ii]][[jj]][["area.name"]]       = switch(i, "CST", "")
	stock[[ii]][[jj]][["prefix"]]          = switch(i, "car.","xxx.") ## use istock
	#stock[[ii]][[jj]][["model.dir"]]       = "C:/Users/haighr/Files/GFish/PSARC22/CAR/Data/SS"
	stock[[ii]][[jj]][["model.dir"]]       = "C:/Users/haighr/Files/GFish/PSARC/PSARC_2020s/PSARC22/CAR/Data/SS"
	stock[[ii]][[jj]][["base.dir"]]        = paste0(stock[[ii]][[jj]][["model.dir"]], switch(i, "/CAR2022","/nada")) ## Top level directory for runs
	stock[[ii]][[jj]][["startYear"]]       = 1935
	stock[[ii]][[jj]][["currYear"]]        = 2023
	stock[[ii]][[jj]][["prevYear"]]        = 2022
	stock[[ii]][[jj]][["projYear"]]        = 2033  ## 10-yr projection
	stock[[ii]][[jj]][["pgenYear"]]        = 2108  ## 75-yr projection  ## 3G (G=25y)
	stock[[ii]][[jj]][["gen1"]]            = 25
	stock[[ii]][[jj]][["Ngen"]]            = 3
	stock[[ii]][[jj]][["Nsex"]]            = 2
	stock[[ii]][[jj]][["Nsurv"]]           = switch(i, 6, 1)
	stock[[ii]][[jj]][["Ncpue"]]           = switch(i, 1, 1)
	stock[[ii]][[jj]][["Ngear"]]           = switch(i, 2, 1)
	...
	stock[[ii]][[jj]][["exp.run.num"]]     = switch(i, 24, 0)
	stock[[ii]][[jj]][["exp.run.rwt"]]     = switch(i, "24.01", "")
	stock[[ii]][[jj]][["recentCatch"]]     = switch(i, c('2017'=833.1,'2018'=892.5,'2019'=652.7,'2020'=832.7,'2021'=732.8), 0) ## for now just provide the data
	## Axes of uncertainty (set to NULL if none)
	stock[[ii]][[jj]][["axisU"]]           = switch(i, runA, runB)
	stock[[ii]][[jj]][["fleets"]]          = switch(i, c("Trawl", "Other", "QCS Synoptic", "WCVI Synoptic", "NMFS Triennial", "HS Synoptic", "WCHG Synoptic", "GIG Historical","HBLL North","HBLL South"), c( "nada") )  ## index series
	stock[[ii]][[jj]][["iseries"]]         = switch(i, c("Bottom Trawl CPUE", "QCS Synoptic", "WCVI Synoptic", "NMFS Triennial", "HS Synoptic", "WCHG Synoptic", "GIG Historical"), c( "nada") )  ## index series
	stock[[ii]][[jj]][["gseries"]]         = switch(i, c("Trawl","Other"), c("nada"))  ## gear series
	...
	stock[[ii]][[jj]][["sseries"]]         = switch(i, c(rep(list(c(1,3:8)),10), list(c(1,3:10)), list(c(1,3:8))) , rep(list(c(1,3:8)),15) )  ## survey series for comparing sens to base parameters
	stock[[ii]][[jj]][["sen.run.num"]]     = switch(i, c(25:37,49), c(0) )
	stock[[ii]][[jj]][["sen.rwt.num"]]     = switch(i, rep(1,14), c(0) )
	stock[[ii]][[jj]][["sen.lab"]]         = switch(i,
		c("split_M_ages(13,14)", "AE1_no_age_error", "AE5_age_reader_CV", "AE6_CASAL_CV=0.1", "reduce_catch_30%", "increase_catch_50%", "sigmaR=0.6", "sigmaR=1.2", "female_dome_select", "use_AF_HS_WCHG", "add_HBLL_surveys", "use_Tweedie_CPUE", "remove_comm_CPUE", "use Francis reweight"),
		c("lemony persnickets"))
	stock[[ii]][[jj]][["sen.long"]]         = switch(i,
		c("split M between ages 13 and 14", "apply no ageing error", "use smoothed ageing error from age-reader CVs", "use constant-CV ageing error", "reduce commercial catch (1965-95) by 30\\\\pc{}", "increase commercial catch (1965-95) by 50\\\\pc{}", "reduce $\\\\sigma_R$ to 0.6", "increase $\\\\sigma_R$ to 1.2", "use female dome-shaped selectivity", "use AF data from HS \\\\& WCHG synoptic surveys", "add HBLL North \\\\& South surveys", "use CPUE fitted by Tweedie distribution", "remove commercial CPUE series", "use Francis mean-age reweighting"),
		c("lemony persnickets"))
