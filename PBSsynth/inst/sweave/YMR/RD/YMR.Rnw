...
\begin{itemize_csas}
  ...
  \item \textbf{S12}~(Run\Sexpr{pad0(sen.run.num[12],2)}) -- reduce steepness from $h$=0.7 to $h$=0.5 (label:~``\Sexpr{gsub("_","~",sen.lab[12])}'');
  \item \textbf{S13}~(Run\Sexpr{pad0(sen.run.num[13],2)}) -- double 2021 catch from 1057\,t to 2114\,t (label:~``\Sexpr{gsub("_","~",sen.lab[13])}'');
  \item \textbf{S14}~(Run\Sexpr{pad0(sen.run.num[14],2)}) -- use AE based on ageing precision (label:~``\Sexpr{gsub("_","~",sen.lab[14])}'').
\end{itemize_csas}
...
\begin{itemize_csas}
  ...
  \begin{itemize_csas}
    ...
    \item S12 (\Sexpr{gsub("_","~",sen.lab[12])})
    \item S13 (\Sexpr{gsub("_","~",sen.lab[13])})
    \item S14 (\Sexpr{gsub("_","~",sen.lab[14])})
  \end{itemize_csas}
