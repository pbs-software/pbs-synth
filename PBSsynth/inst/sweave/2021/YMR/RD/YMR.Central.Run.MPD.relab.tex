...
\onefig{harmonica0}{Unweighted AF: harmonic mean of effective sample size (horizontal dashed line) vs. arithmetic mean of observed sample size (vertical dashed line). Solid line shows 1:1 relationship; red dashed curve shows first-order polynomial regression fit.}{Central Run 75: }{ymr.}
...
\onefig{meanAge}{Mean ages each year for the \textbf{weighted} data (solid green circles) where vertical bars denote the range of the data and cross bars denote $\sim$95\pc{} confidence intervals associated with adjusted sample sizes; model estimates of mean age appear as blue lines.}{Central Run 75: }{ymr.}
...
\twofig{Bt}{BtB0}{Spawning biomass $B_t$ (tonnes, mature females) over time (top), and spawning biomass $B_t$ relative to unfished equilbrium spawning biomass $B_0$ (bottom). Blue line designates SS fit for \currYear.}{Central Run 75: }{ymr.}
