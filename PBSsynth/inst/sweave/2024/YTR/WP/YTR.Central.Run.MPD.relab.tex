...
\onefig{osa.residuals.fleet1.sexF}{BC Trawl Fishery one-step-ahead residuals for females: (top left) bubble plot of composition residuals (positive in blue, negative in red, legend at bottom left); (top right) autocorrelation by row (age), column (year), and diagonal; (bottom left) quantile-quantile plot with points colour-coded by age; (bottom right) standard normal residuals, points colour-coded by age}{Base run: }{ytr.}
