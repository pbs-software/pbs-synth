...
This appendix describes model results for a coastwide stock of \SPP{} (\SPC, \emph{\Sexpr{latin.name}}) that spans the outer British Columbia (BC) coast, covering PMFC areas 3CD (south), 5ABC (central), and 5DE (north).
