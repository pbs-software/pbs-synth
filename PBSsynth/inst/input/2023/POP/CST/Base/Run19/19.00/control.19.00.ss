...
0.02 0.2 0.060 0.060 0.012 6 4 0 0 0 0 0 0 0 #_mgpF_gp1_M
...
0.02 0.2 0.060 0.060 0.012 6 4 0 0 0 0 0 0 0 #_mgpM_gp1_M
...
2 1 0 0 0 1 #_q_setup_idx_wcvi
#6 1 0 0 0 1 #_q_setup_idx_wchg
#7 1 0 0 0 1 #_q_setup_idx_gig
3 1 0 0 0 1 #_q_setup_idx_nmfs
4 1 0 0 0 1 #_q_setup_idx_gbr
...
#5 40 10.72 10.72 3.216 6 3 0 0 0 0 0 0 0 #_s_p1_trawl_5abc -- peak: beginning size (or age) for the plateau (=mu in Awatea)
#0 60 0 0 99 0 -3 0 0 0 0 0 0 0 #_s_p2_trawl_5abc -- top: width of plateau; as logistic between peak and maximum length (or age)
#-15 15 1.6 1.6 0.48 6 4 0 0 0 0 0 0 0 #_s_p3_trawl_5abc -- ascending width: parameter value is ln(width) (=log varL in Awatea)
...
#-8 10 0.01853 0.01853 0.005559 6 4 0 0 0 0 0 0 0 #_s_p1_trawl_5abc_male -- size (age) at which a dogleg (inflection point?) occurs (=Delta in Awatea)
...
# 2_TRAWL_FISHERY_3CD AgeSelex    # mirrors fleet 1 (5ABC Trawl)  -- not in 3CD single-area model
# female_selectivity_pattern_20
...
# 9_WCVI_HISTORICAL AgeSelex    # mirrors fleet 2 (WCVI synoptic)
#
...
#-5 10 0 0 1.813 6 2 0 0 0 0 0 0 0 #_s_w9_ln(dm_parm)_gbr   #_Apparently do not specify fleets w/out AF data in this section
# #_LO HI INIT PRIOR PR_SD PR_type PHASE env-var use_dev dev_mnyr dev_mxyr dev_PH Block Blk_Fxn
