...
10 1 0 0 0 0 #_q_setup_idx_hblln
11 1 0 0 0 0 #_q_setup_idx_hblls
...
-15 15 -3 -3 6 6 1 0 0 0 0 0 0 0 #_q_parms_idx_hblln
-15 15 -3 -3 6 6 1 0 0 0 0 0 0 0 #_q_parms_idx_hblls
...
# female_selectivity_pattern_20
1 60 15 15 5 6 3 0 0 0 0 0 0 0 #_s_p1_hblln -- peak: beginning size (or age) for the plateau (=mu in Awatea)
0 60 0 0 99 0 -3 0 0 0 0 0 0 0 #_s_p2_hblln -- top: width of plateau; as logistic between peak and maximum length (or age)
-5 10 0.5 0.5 1 6 4 0 0 0 0 0 0 0 #_s_p3_hblln -- ascending width: parameter value is ln(width) (=log varL in Awatea)
...
# male_selectivity_option_3
# p1size (age) at which a dogleg occurs
-10 10 0 0 1 6 4 0 0 0 0 0 0 0 #_s_p1_hblln_male -- size (age) at which a dogleg (inflection point?) occurs (=Delta in Awatea)
...
# female_selectivity_pattern_20
1 60 15 15 5 6 3 0 0 0 0 0 0 0 #_s_p1_hblls -- peak: beginning size (or age) for the plateau (=mu in Awatea)
0 60 0 0 99 0 -3 0 0 0 0 0 0 0 #_s_p2_hblls -- top: width of plateau; as logistic between peak and maximum length (or age)
-5 10 0.5 0.5 1 6 4 0 0 0 0 0 0 0 #_s_p3_hblls -- ascending width: parameter value is ln(width) (=log varL in Awatea)
...
# male_selectivity_option_3
# p1size (age) at which a dogleg occurs
-10 10 0 0 1 6 4 0 0 0 0 0 0 0 #_s_p1_hblls_male -- size (age) at which a dogleg (inflection point?) occurs (=Delta in Awatea)
...
1 10 0 #_vadj_cv_hblln_idx
1 11 0 #_vadj_cv_hblls_idx
# SS_tune_comps(rlist; option="Francis") on Multinomial
5 1 1.70245381162448 #_vadj_af_trawl_5abc
5 2 1.09727887942803 #_vadj_af_trawl_5de
5 3 0.755392005608748 #_vadj_af_trawl_3cd
5 4 0.268281646800099 #_vadj_af_qcs
5 5 0.376981311495304 #_vadj_af_wchg
5 6 0.236793496158028 #_vadj_af_wcvi
#5 7 1 #_vadj_af_hs
#5 8 1 #_vadj_af_gig
#5 9 1 #_vadj_af_nmfs
5 10 0.153542906382191 #_vadj_af_hblln
5 11 0.0936752144644273 #_vadj_af_hblls
