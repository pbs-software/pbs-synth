...
8 1 0 0 0 1 #_q_setup_idx_hblln
9 1 0 0 0 1 #_q_setup_idx_hblls
...
15 0 0 8 #_s_pat_age_hblls HBLL_SOUTH
#
...
# 8_HBLL_NORTH AgeSelex
# female_selectivity_pattern_20
5 40 8 8 8 0 -3 0 0 0 0 0 0 0 #_s_p1_hblln -- peak: beginning size (or age) for the plateau (=mu in Awatea)
0 60 0 0 99 0 -3 0 0 0 0 0 0 0 #_s_p2_hblln -- top: width of plateau; as logistic between peak and maximum length (or age)
-15 15 2 2 2 0 -4 0 0 0 0 0 0 0 #_s_p3_hblln -- ascending width: parameter value is ln(width) (=log varL in Awatea)
...
# male_selectivity_option_3
# p1size (age) at which a dogleg occurs
-10 10 0 0 10 0 -4 0 0 0 0 0 0 0 #_s_p1_hblln_male -- size (age) at which a dogleg (inflection point?) occurs (=Delta in Awatea)
...
# 9_HBLL_SOUTH AgeSelex # mirrors fleet 8 (HBLL North)
#
...
5 1 2.56162677138979 #_vadj_af_trawl_bc
5 2 1.99020855094498 #_vadj_af_qcs
5 3 2.61428935019828 #_vadj_af_wcvi
# 5 5 1 #_vadj_af_hs
# 5 6 1 #_vadj_af_gig
5 7 1.58141993230724 #_vadj_af_nmfs
