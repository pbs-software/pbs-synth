...
#_Pattern Discard Male Special (change to female)
20 0 4 0 #_s_pat_age_bc TRAWL_FISHERY_BC
20 0 4 0 #_s_pat_age_qcs QCS_SYNOPTIC
20 0 4 0 #_s_pat_age_wcvi WCVI_SYNOPTIC
20 0 4 0 #_s_pat_age_wchg WCHG_SYNOPTIC
20 0 4 0 #_s_pat_age_hs HS_SYNOPTIC
15 0 0 2 #_s_pat_age_gig GIG_HISTORICAL
20 0 4 0 #_s_pat_age_nmfs NMFS_TRIENNIAL
...
-15 0 -10 -10 0.01 0 -3 0 0 0 0 0 0 0 #_s_p2_trawl_bc -- top: width of plateau; as logistic between peak and maximum length (or age)
-15 15 2 2 2 6 4 0 0 0 0 0 0 0 #_s_p3_trawl_bc -- ascending width: parameter value is ln(width) (=log varL in Awatea)
-15 15 2.5 2.5 0.75 6 4 0 0 0 0 0 0 0 #_s_p4_trawl_bc -- descending width: parameter value is ln(width) (=log varR in Awatea)
-10 10 -999 0 99 0 -50 0 0 0 0 0 0 0 #_s_p5_trawl_bc -- initial: selectivity at first bin; as logistic between 0 and 1
0 15 10 10 0.01 6 4 0 0 0 0 0 0 0 #_s_p6_trawl_bc -- final: selectivity at last bin; as logistic between 0 and 1
# female_selectivity_option_4
# p1size (age) at which a dogleg occurs
-10 10 0 0 10 6 4 0 0 0 0 0 0 0 #_s_p1_trawl_bc_offset -- size (age) at which a dogleg (inflection point?) occurs (=Delta in Awatea)
-30 30 0 0 3 6 4 0 0 0 0 0 0 0 #_s_p2_trawl_bc_offset -- added to the third selectivity parameter (width of ascending side)
-30 30 0 0 3 6 4 0 0 0 0 0 0 0 #_s_p3_trawl_bc_offset -- added to the fourth selectivity parameter (width of descending side)
-30 30 -10 -10 10 6 4 0 0 0 0 0 0 0 #_s_p4_trawl_bc_offset -- added to the sixth selectivity parameter (selectivity at final size bin)
0 1 1 1 0 0 -50 0 0 0 0 0 0 0 #_s_p5_trawl_bc_offset -- delta parameter 5 is the apical selectivity for offset sex
...
5 1 2.35064899283717 #_vadj_af_trawl_bc
5 2 2.05773794154012 #_vadj_af_qcs
5 3 3.81361853505391 #_vadj_af_wcvi
# 5 5 1 #_vadj_af_hs
# 5 6 1 #_vadj_af_gig
5 7 1.8349295128398 #_vadj_af_nmfs
