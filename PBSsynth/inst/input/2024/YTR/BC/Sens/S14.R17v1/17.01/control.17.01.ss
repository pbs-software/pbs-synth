...
0 0 0 0 #_s_pat_len_bt
0 0 0 0 #_s_pat_len_mw
...
#_Pattern Discard Male Special
20 0 3 0 #_s_pat_age_bt BT_FISHERY_BC
20 0 3 0 #_s_pat_age_mw MW_FISHERY_BC
...
15 0 0 3 #_s_pat_age_gig GIG_HISTORICAL
...
# 1_BT_FISHERY_BC AgeSelex
# female_selectivity_pattern_20
5 40 11 11 11 6 3 0 0 0 0 0 0 0 #_s_p1_trawl_bt -- peak: beginning size (or age) for the plateau (=mu in Awatea)
0 60 0 0 99 0 -3 0 0 0 0 0 0 0 #_s_p2_trawl_bt -- top: width of plateau; as logistic between peak and maximum length (or age)
-15 15 2 2 2 6 4 0 0 0 0 0 0 0 #_s_p3_trawl_bt -- ascending width: parameter value is ln(width) (=log varL in Awatea)
-15 500 200 0 1 0 -4 0 0 0 0 0 0 0 #_s_p4_trawl_bt -- descending width: parameter value is ln(width) (=log varR in Awatea)
-10 10 -999 0 99 0 -50 0 0 0 0 0 0 0 #_s_p5_trawl_bt -- initial: selectivity at first bin; as logistic between 0 and 1
-10 10 -999 0 99 0 -50 0 0 0 0 0 0 0 #_s_p6_trawl_bt -- final: selectivity at last bin; as logistic between 0 and 1
# male_selectivity_option_3
# p1size (age) at which a dogleg occurs
-10 10 0 0 10 6 4 0 0 0 0 0 0 0 #_s_p1_trawl_bt_male -- size (age) at which a dogleg (inflection point?) occurs (=Delta in Awatea)
-15 15 0 0 2.5 0 -4 0 0 0 0 0 0 0 #_s_p2_trawl_bt_male -- added to the third selectivity parameter (width of ascending side)
-15 500 0 0 0.6 0 -4 0 0 0 0 0 0 0 #_s_p3_trawl_bt_male -- added to the fourth selectivity parameter (width of descending side)
-10 10 0 0 99 0 -50 0 0 0 0 0 0 0 #_s_p4_trawl_bt_male -- added to the sixth selectivity parameter (selectivity at final size bin)
0 1 1 1 0 0 -50 0 0 0 0 0 0 0 #_s_p5_trawl_bt_male -- male parameter 5 is the apical selectivity for males
# 2_MW_FISHERY_BC AgeSelex
# female_selectivity_pattern_20
5 40 11 11 11 6 3 0 0 0 0 0 0 0 #_s_p1_trawl_mw -- peak: beginning size (or age) for the plateau (=mu in Awatea)
0 60 0 0 99 0 -3 0 0 0 0 0 0 0 #_s_p2_trawl_mw -- top: width of plateau; as logistic between peak and maximum length (or age)
-15 15 2 2 2 6 4 0 0 0 0 0 0 0 #_s_p3_trawl_mw -- ascending width: parameter value is ln(width) (=log varL in Awatea)
-15 500 200 0 1 0 -4 0 0 0 0 0 0 0 #_s_p4_trawl_mw -- descending width: parameter value is ln(width) (=log varR in Awatea)
-10 10 -999 0 99 0 -50 0 0 0 0 0 0 0 #_s_p5_trawl_mw -- initial: selectivity at first bin; as logistic between 0 and 1
-10 10 -999 0 99 0 -50 0 0 0 0 0 0 0 #_s_p6_trawl_mw -- final: selectivity at last bin; as logistic between 0 and 1
# male_selectivity_option_3
# p1size (age) at which a dogleg occurs
-10 10 0 0 10 6 4 0 0 0 0 0 0 0 #_s_p1_trawl_mw_male -- size (age) at which a dogleg (inflection point?) occurs (=Delta in Awatea)
-15 15 0 0 2.5 0 -4 0 0 0 0 0 0 0 #_s_p2_trawl_mw_male -- added to the third selectivity parameter (width of ascending side)
-15 500 0 0 0.6 0 -4 0 0 0 0 0 0 0 #_s_p3_trawl_mw_male -- added to the fourth selectivity parameter (width of descending side)
-10 10 0 0 99 0 -50 0 0 0 0 0 0 0 #_s_p4_trawl_mw_male -- added to the sixth selectivity parameter (selectivity at final size bin)
0 1 1 1 0 0 -50 0 0 0 0 0 0 0 #_s_p5_trawl_mw_male -- male parameter 5 is the apical selectivity for males
...
# 7_GIG_HISTORICAL AgeSelex # mirrors fleet 3 (QCS synoptic)
# female_selectivity_pattern_20
...
# 8_WCVI_HISTORICAL AgeSelex # not used but would mirror fleet 4 (WCVI synoptic)
#
...
5 1 2.18685700434131 #_vadj_af_bt_bc
5 2 2.82111665791049 #_vadj_af_mw_bc
5 3 1.8148733633175 #_vadj_af_qcs
5 4 2.40531853586664 #_vadj_af_wcvi
# 5 5 1 #_vadj_af_hs
# 5 6 1 #_vadj_af_gig
5 8 1.47680244315682 #_vadj_af_nmfs
