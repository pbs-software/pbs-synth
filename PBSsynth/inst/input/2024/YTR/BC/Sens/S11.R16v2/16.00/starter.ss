...
data.16.00.ss #_dat_file -- data file name : Put first set of ss files (*,00.00.ss) in YTR2024 directory
control.16.00.ss #_ctl_file -- control file name
...
9 #_min_age_b_sum -- Min age for summary biomass
