...
#_C input names of data and control files 
data.91.00.ss #_dat_file -- data file name
control.91.00.ss #_ctl_file -- control file name
...
#_COND_xyr -- vector of year values 
...
#_10 15 #_COND_f_units -- min and max age over which average F will be calculated with F_reporting=4 or 5
...
#_-1 #_COND_seed_boot -- random number seed for bootstrap data (-1 to use long(time) as seed): 1585083947
