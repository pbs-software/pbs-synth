...
#_Pattern Discard Male Special
20 0 4 0 #_s_pat_age_trawl
20 0 4 0 #_s_pat_age_other
20 0 4 0 #_s_pat_age_qci
20 0 4 0 #_s_pat_age_wcvi
20 0 4 0 #_s_pat_age_nmfs
20 0 4 0 #_s_pat_age_hs
20 0 4 0 #_s_pat_age_wchg
20 0 4 0 #_s_pat_age_gig
#
...
# male_selectivity_pattern_20
5 40 14 14 4.2 6 3 0 0 0 0 0 0 0 #_s_p1_trawl -- peak: beginning size (or age) for the plateau (=mu in Awatea)
-15 0 -10 -10 0.01 0 -3 0 0 0 0 0 0 0 #_s_p2_trawl -- top: width of plateau; as logistic between peak and maximum length (or age)
-15 15 2.5 2.5 0.75 6 4 0 0 0 0 0 0 0 #_s_p3_trawl -- ascending width: parameter value is ln(width) (=log varL in Awatea)
-15 15 2.5 2.5 0.75 6 4 0 0 0 0 0 0 0 #_s_p4_trawl -- descending width: parameter value is ln(width) (=log varR in Awatea)
-10 10 -999 0 99 0 -50 0 0 0 0 0 0 0 #_s_p5_trawl -- initial: selectivity at first bin; as logistic between 0 and 1
0 15 10 10 0.01 6 4 0 0 0 0 0 0 0 #_s_p6_trawl -- final: selectivity at last bin; as logistic between 0 and 1
# female_selectivity_option_4
# p1size (age) at which a dogleg occurs
-8 10 -0.4 -0.4 0.12 6 4 0 0 0 0 0 0 0 #_s_p1_trawl_offset -- size (age) at which a dogleg occurs (=Delta in Awatea)
-30 30 0 0 3 6 4 0 0 0 0 0 0 0 #_s_p2_trawl_offset -- added to the third selectivity parameter (width of ascending side)
-30 30 0 0 3 6 4 0 0 0 0 0 0 0 #_s_p3_trawl_offset -- added to the fourth selectivity parameter (width of descending side)
-30 30 -10 -10 10 6 4 0 0 0 0 0 0 0 #_s_p4_trawl_offset -- added to the sixth selectivity parameter (selectivity at final size bin)
0 1 1 1 0 0 -50 0 0 0 0 0 0 0 #_s_p5_trawl_offset -- delta parameter 5 is the apical selectivity for offset sex
...
-15 0 -10 -10 0.01 0 -3 0 0 0 0 0 0 0 #_s_p2_other -- top: width of plateau; as logistic between peak and maximum length (or age)
...
# female_selectivity_option_4
# p1size (age) at which a dogleg occurs
-8 10 -0.4 -0.4 0.4 0 -4 0 0 0 0 0 0 0 #_s_p1_other_offset -- size (age) at which a dogleg occurs (=Delta in Awatea)
-15 15 0 0 3 0 -4 0 0 0 0 0 0 0 #_s_p2_other_offset -- added to the third selectivity parameter (width of ascending side)
-15 15 0 0 3 0 -4 0 0 0 0 0 0 0 #_s_p3_other_offset -- added to the fourth selectivity parameter (width of descending side)
-10 10 0 0 3 0 -4 0 0 0 0 0 0 0 #_s_p4_other_offset -- added to the sixth selectivity parameter (selectivity at final size bin)
0 1 1 1 0 0 -50 0 0 0 0 0 0 0 #_s_p5_other_offset -- delta parameter 5 is the apical selectivity for offset sex
...
-15 0 -10 -10 0.01 0 -3 0 0 0 0 0 0 0 #_s_p2_qcs -- top: width of plateau; as logistic between peak and maximum length (or age)
-15 15 2.5 2.5 0.75 6 4 0 0 0 0 0 0 0 #_s_p3_qcs -- ascending width: parameter value is ln(width) (=log varL in Awatea)
-15 15 2.5 2.5 0.75 6 4 0 0 0 0 0 0 0 #_s_p4_qcs -- descending width: parameter value is ln(width) (=log varR in Awatea)
-10 10 -999 0 99 0 -50 0 0 0 0 0 0 0 #_s_p5_qcs -- initial: selectivity at first bin; as logistic between 0 and 1
0 15 10 10 0.01 6 4 0 0 0 0 0 0 0 #_s_p6_qcs -- final: selectivity at last bin; as logistic between 0 and 1
# female_selectivity_option_4
# p1size (age) at which a dogleg occurs
-8 10 -0.4 -0.4 0.12 6 4 0 0 0 0 0 0 0 #_s_p1_qcs_offset -- size (age) at which a dogleg occurs (=Delta in Awatea)
-30 30 0 0 3 6 4 0 0 0 0 0 0 0 #_s_p2_qcs_offset -- added to the third selectivity parameter (width of ascending side)
-30 30 0 0 3 6 4 0 0 0 0 0 0 0 #_s_p3_qcs_offset -- added to the fourth selectivity parameter (width of descending side)
-30 30 -10 -10 10 6 4 0 0 0 0 0 0 0 #_s_p4_qcs_offset -- added to the sixth selectivity parameter (selectivity at final size bin)
0 1 1 1 0 0 -50 0 0 0 0 0 0 0 #_s_p5_qcs_offset -- delta parameter 5 is the apical selectivity for offset sex
...
-15 0 -10 -10 0.01 0 -3 0 0 0 0 0 0 0 #_s_p2_wcvi -- top: width of plateau; as logistic between peak and maximum length (or age)
-15 15 2.5 2.5 0.75 6 4 0 0 0 0 0 0 0 #_s_p3_wcvi -- ascending width: parameter value is ln(width) (=log varL in Awatea)
-15 15 2.5 2.5 0.75 6 4 0 0 0 0 0 0 0 #_s_p4_wcvi -- descending width: parameter value is ln(width) (=log varR in Awatea)
-10 10 -999 0 99 0 -50 0 0 0 0 0 0 0 #_s_p5_wcvi -- initial: selectivity at first bin; as logistic between 0 and 1
0 15 10 10 0.01 6 4 0 0 0 0 0 0 0 #_s_p6_wcvi -- final: selectivity at last bin; as logistic between 0 and 1
# female_selectivity_option_4
# p1size (age) at which a dogleg occurs
-8 10 -0.4 -0.4 0.12 6 4 0 0 0 0 0 0 0 #_s_p1_wcvi_offset -- size (age) at which a dogleg occurs (=Delta in Awatea)
-30 30 0 0 3 6 4 0 0 0 0 0 0 0 #_s_p2_wcvi_offset -- added to the third selectivity parameter (width of ascending side)
-30 30 0 0 3 6 4 0 0 0 0 0 0 0 #_s_p3_wcvi_offset -- added to the fourth selectivity parameter (width of descending side)
-30 30 -10 -10 10 6 4 0 0 0 0 0 0 0 #_s_p4_wcvi_offset -- added to the sixth selectivity parameter (selectivity at final size bin)
0 1 1 1 0 0 -50 0 0 0 0 0 0 0 #_s_p5_wcvi_offset -- delta parameter 5 is the apical selectivity for offset sex
# 5_NMFS_TRIENNIAL AgeSelex
# male_selectivity_pattern_20
5 40 12.28 14 4.2 0 -3 0 0 0 0 0 0 0 #_s_p1_nmfs -- peak: beginning size (or age) for the plateau (=mu in Awatea)
-15 0 -10 -10 0.01 0 -3 0 0 0 0 0 0 0 #_s_p2_nmfs -- top: width of plateau; as logistic between peak and maximum length (or age)
-15 15 2.765 2.5 0.75 0 -4 0 0 0 0 0 0 0 #_s_p3_nmfs -- ascending width: parameter value is ln(width) (=log varL in Awatea)
-15 15 2.595 2.5 0.75 0 -4 0 0 0 0 0 0 0 #_s_p4_nmfs -- descending width: parameter value is ln(width) (=log varR in Awatea)
-10 10 -999 0 99 0 -50 0 0 0 0 0 0 0 #_s_p5_nmfs -- initial: selectivity at first bin; as logistic between 0 and 1
0 15 10 10 0.01 0 -4 0 0 0 0 0 0 0 #_s_p6_nmfs -- final: selectivity at last bin; as logistic between 0 and 1
# female_selectivity_option_4
# p1size (age) at which a dogleg occurs
-8 10 -0.397 -0.4 0.12 0 -4 0 0 0 0 0 0 0 #_s_p1_nmfs_offset -- size (age) at which a dogleg occurs (=Delta in Awatea)
-30 30 -0.379 0 3 0 -4 0 0 0 0 0 0 0 #_s_p2_nmfs_offset -- added to the third selectivity parameter (width of ascending side)
-30 30 1.516 0 3 0 -4 0 0 0 0 0 0 0 #_s_p3_nmfs_offset -- added to the fourth selectivity parameter (width of descending side)
-30 30 -12.165 -10 10 0 -4 0 0 0 0 0 0 0 #_s_p4_nmfs_offset -- added to the sixth selectivity parameter (selectivity at final size bin)
0 1 1 1 0 0 -50 0 0 0 0 0 0 0 #_s_p5_nmfs_offset -- delta parameter 5 is the apical selectivity for offset sex
# 6_HS_SYNOPTIC AgeSelex
# male_selectivity_pattern_20
5 40 12.825 14 14 0 -3 0 0 0 0 0 0 0 #_s_p1_hs -- peak: beginning size (or age) for the plateau (=mu in Awatea)
-15 0 -10 -10 0.01 0 -3 0 0 0 0 0 0 0 #_s_p2_hs -- top: width of plateau; as logistic between peak and maximum length (or age)
-15 15 2.859 2.5 2.5 0 -4 0 0 0 0 0 0 0 #_s_p3_hs -- ascending width: parameter value is ln(width) (=log varL in Awatea)
-15 500 2.582 0 1 0 -4 0 0 0 0 0 0 0 #_s_p4_hs -- descending width: parameter value is ln(width) (=log varR in Awatea)
-10 10 -999 0 99 0 -50 0 0 0 0 0 0 0 #_s_p5_hs -- initial: selectivity at first bin; as logistic between 0 and 1
-10 10 10 0 99 0 -50 0 0 0 0 0 0 0 #_s_p6_hs -- final: selectivity at last bin; as logistic between 0 and 1
# female_selectivity_option_4
# p1size (age) at which a dogleg occurs
-8 10 -0.396 -0.4 0.4 0 -4 0 0 0 0 0 0 0 #_s_p1_hs_offset -- size (age) at which a dogleg occurs (=Delta in Awatea)
-15 15 -0.192 0 3 0 -4 0 0 0 0 0 0 0 #_s_p2_hs_offset -- added to the third selectivity parameter (width of ascending side)
-15 15 1.318 0 3 0 -4 0 0 0 0 0 0 0 #_s_p3_hs_offset -- added to the fourth selectivity parameter (width of descending side)
-10 10 -10.443 0 3 0 -4 0 0 0 0 0 0 0 #_s_p4_hs_offset -- added to the sixth selectivity parameter (selectivity at final size bin)
0 1 1 1 0 0 -50 0 0 0 0 0 0 0 #_s_p5_hs_offset -- delta parameter 5 is the apical selectivity for offset sex
...
# female_selectivity_option_4
# p1size (age) at which a dogleg occurs
-8 10 -0.4 -0.4 0.4 0 -4 0 0 0 0 0 0 0 #_s_p1_wchg_offset -- size (age) at which a dogleg occurs (=Delta in Awatea)
-15 15 0 0 3 0 -4 0 0 0 0 0 0 0 #_s_p2_wchg_offset -- added to the third selectivity parameter (width of ascending side)
-15 15 0 0 3 0 -4 0 0 0 0 0 0 0 #_s_p3_wchg_offset -- added to the fourth selectivity parameter (width of descending side)
-10 10 0 0 3 0 -4 0 0 0 0 0 0 0 #_s_p4_wchg_offset -- added to the sixth selectivity parameter (selectivity at final size bin)
0 1 1 1 0 0 -50 0 0 0 0 0 0 0 #_s_p5_wchg_offset -- delta parameter 5 is the apical selectivity for offset sex
# 8_GIG_HISTORICAL AgeSelex
# male_selectivity_pattern_20
5 40 12.825 14 14 0 -3 0 0 0 0 0 0 0 #_s_p1_gig -- peak: beginning size (or age) for the plateau (=mu in Awatea)
-15 0 -10 -10 0.01 0 -3 0 0 0 0 0 0 0 #_s_p2_gig -- top: width of plateau; as logistic between peak and maximum length (or age)
-15 15 2.859 2.5 2.5 0 -4 0 0 0 0 0 0 0 #_s_p3_gig -- ascending width: parameter value is ln(width) (=log varL in Awatea)
-15 500 2.582 0 1 0 -4 0 0 0 0 0 0 0 #_s_p4_gig -- descending width: parameter value is ln(width) (=log varR in Awatea)
-10 10 -999 0 99 0 -50 0 0 0 0 0 0 0 #_s_p5_gig -- initial: selectivity at first bin; as logistic between 0 and 1
-10 10 10 0 99 0 -50 0 0 0 0 0 0 0 #_s_p6_gig -- final: selectivity at last bin; as logistic between 0 and 1
# female_selectivity_option_4
# p1size (age) at which a dogleg occurs
-8 10 -0.396 -0.4 0.4 0 -4 0 0 0 0 0 0 0 #_s_p1_gig_offset -- size (age) at which a dogleg occurs (=Delta in Awatea)
-15 15 -0.192 0 3 0 -4 0 0 0 0 0 0 0 #_s_p2_gig_offset -- added to the third selectivity parameter (width of ascending side)
-15 15 1.318 0 3 0 -4 0 0 0 0 0 0 0 #_s_p3_gig_offset -- added to the fourth selectivity parameter (width of descending side)
-10 10 -10.443 0 3 0 -4 0 0 0 0 0 0 0 #_s_p4_gig_offset -- added to the sixth selectivity parameter (selectivity at final size bin)
0 1 1 1 0 0 -50 0 0 0 0 0 0 0 #_s_p5_gig_offset -- delta parameter 5 is the apical selectivity for offset sex
