...
5 1 0.630771904419904 #_vadj_af_mn_trawl
5 3 0.598941268413134 #_vadj_af_mn_qcs
5 4 0.709557740100349 #_vadj_af_mn_wcvi
5 5 3.13617544667652 #_vadj_af_mn_nmfs
...
#
2 #_read_sd_rep -- (0/1) read specs for more stddev reporting
0 2 -1 5 # Selectivity
0 5 # Growth
0 -1 5 # Numbers-at-age
0 0 # Natural mortality-at-age
0 # Dynamic B0
1 # Summary Bio (SmryBio = biomass for min age and above -- set in `starter.ss'; if min age == 0, SmryBio=TotBio, presumably)
