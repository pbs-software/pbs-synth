...
9 1 0 0 0 1 #_q_setup_idx_hblln
10 1 0 0 0 1 #_q_setup_idx_hblls
...
20 0 3 0 #_s_pat_age_hblln
20 0 3 0 #_s_pat_age_hblls
#
...
# 9_HBLL_NORTH AgeSelex
# female_selectivity_pattern_20
5 40 14 14 4.2 6 3 0 0 0 0 0 0 0 #_s_p1_hblln -- peak: beginning size (or age) for the plateau (=mu in Awatea)
0 60 0 0 99 0 -3 0 0 0 0 0 0 0 #_s_p2_hblln -- top: width of plateau; as logistic between peak and maximum length (or age)
-15 15 2.5 2.5 0.75 6 4 0 0 0 0 0 0 0 #_s_p3_hblln -- ascending width: parameter value is ln(width) (=log varL in Awatea)
...
# male_selectivity_option_3
# p1size (age) at which a dogleg occurs
-8 10 -0.4 -0.4 0.12 6 4 0 0 0 0 0 0 0 #_s_p1_hblln_male -- size (age) at which a dogleg (inflection point?) occurs (=Delta in Awatea)
...
# 10_HBLL_SOUTH AgeSelex
# female_selectivity_pattern_20
5 40 14 14 4.2 6 3 0 0 0 0 0 0 0 #_s_p1_hblls -- peak: beginning size (or age) for the plateau (=mu in Awatea)
0 60 0 0 99 0 -3 0 0 0 0 0 0 0 #_s_p2_hblls -- top: width of plateau; as logistic between peak and maximum length (or age)
-15 15 2.5 2.5 0.75 6 4 0 0 0 0 0 0 0 #_s_p3_hblls -- ascending width: parameter value is ln(width) (=log varL in Awatea)
...
# male_selectivity_option_3
# p1size (age) at which a dogleg occurs
-8 10 -0.4 -0.4 0.12 6 4 0 0 0 0 0 0 0 #_s_p1_hblls_male -- size (age) at which a dogleg (inflection point?) occurs (=Delta in Awatea)
...
-5 10 0 0 1.813 6 2 0 0 0 0 0 0 0 #_s_w9_ln(dm_parm)_hblln
-5 10 0 0 1.813 6 2 0 0 0 0 0 0 0 #_s_w10_ln(dm_parm)_hblls
# #_LO HI INIT PRIOR PR_SD PR_type PHASE env-var use_dev dev_mnyr dev_mxyr dev_PH Block Blk_Fxn
...
1 9 0 #_vadj_cv_hblln_idx
1 10 0 #_vadj_cv_hblls_idx
...
5 9 1 #_vadj_af_mn_hblln
5 10 1 #_vadj_af_mn_hblls
