...
# female_selectivity_pattern_20
5 40 14 14 4.2 6 3 0 0 0 0 0 0 0 #_s_p1_hs -- peak: beginning size (or age) for the plateau (=mu in Awatea)
0 60 0 0 99 0 -3 0 0 0 0 0 0 0 #_s_p2_hs -- top: width of plateau; as logistic between peak and maximum length (or age)
-15 15 2.5 2.5 0.75 6 4 0 0 0 0 0 0 0 #_s_p3_hs -- ascending width: parameter value is ln(width) (=log varL in Awatea)
...
# male_selectivity_option_3
# p1size (age) at which a dogleg occurs
-8 10 -0.4 -0.4 0.12 6 4 0 0 0 0 0 0 0 #_s_p1_hs_male -- size (age) at which a dogleg (inflection point?) occurs (=Delta in Awatea)
...
# female_selectivity_pattern_20
5 40 14 14 4.2 6 3 0 0 0 0 0 0 0 #_s_p1_wchg -- peak: beginning size (or age) for the plateau (=mu in Awatea)
...
# male_selectivity_option_3
# p1size (age) at which a dogleg occurs
-8 10 -0.4 -0.4 0.12 6 4 0 0 0 0 0 0 0 #_s_p1_wchg_male -- size (age) at which a dogleg (inflection point?) occurs (=Delta in Awatea)
...
-5 10 0 0 1.813 6 2 0 0 0 0 0 0 0 #_s_w6_ln(dm_parm)_hs
-5 10 0 0 1.813 6 2 0 0 0 0 0 0 0 #_s_w7_ln(dm_parm)_wchg
...
5 6 1 #_vadj_af_mn_nmfs
5 7 1 #_vadj_af_mn_nmfs
