...
if(getRversion() >= "2.15.1") utils::globalVariables(names=c(
	...
	"Cum_exp", "Cum_obs",
	"EndStrategy", "EndYear", "Era",
	"Fleet", "Fleet_Name",
	"L1", "Like", "LRP", 
	"M", "M1", "M2", "Method", "MSY.mcmc", "MSYmaxIter", "MSYtol",
	"N2", "Narea", "NCPUEindex", "Ngen", "Ninit", "Nmat", "Nmethods", "NoName", "NrefM", "Nsamp_DM", "Nsens", "Nsexes", "Nsurveyindex",
	"P.mcmc", "P.mpd", "P.rc", "Part",
	"R0", "RecFraction", "RPbase", "RRR", "Rtdev.mcmc",
	"SB0", "SPRloop", "SSB", "Seas", "Sexes", "SfullDelta", "Sfullest", "SpawnBio" , "StartStrategy", "StartYear", "StepStrategy", "StrategyType",
	"TRP", "Time", "TSmat",
	"USR", 
	"VB", "VB0",
	"Yr",
	"acf2", "agile", "alpha", "ampdPA", "area.name", "area.names", "areas", 
		"areaPJ", "areaTS", "assYrs", "avgCP", "avgLL", "avgPA", "avgPJ", "avgR0", "avgRP", "avgTS",
	...
	"d.mcmc", "data.compo.figs", "data_file_name", "decdig", "derposts_file_name", "detectCores", "duplicates",
...
##	"J",
	"kcol",
	"l", "ladbase", "lang", "latex.bold", "lendbase", "log_qCPUE", "log_qsurvey", "log_surveyvarL", "log_surveyvarR", "log_varLest", "log_varRest",
	...
	"sample_admb", "sample_inits", "sarima", "scol", "sen.lab", "sen.mcsubs",
		...
		"sum_Bio_all", "sum_SpawnBio", "sum_catch_tot", "surveySfull", "survey_SfullDelta", "survVec", "symbol", "system_",
